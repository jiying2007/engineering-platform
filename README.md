...
- [Reference-Aligned Implementation Profile v43 — current canonical implementation companion](docs/architecture/REFERENCE_ALIGNED_IMPLEMENTATION_PROFILE_V43.md)
- [Reference-Aligned Implementation Profile v42 — historical](docs/architecture/REFERENCE_ALIGNED_IMPLEMENTATION_PROFILE_V42.md)
...
- [Public Standard Reference Review Round 43 — external identifiers and EPCIS](docs/research/OPEN_SOURCE_REFERENCE_REVIEW_ROUND43_EXTERNAL_IDENTIFIERS_EPCIS_2026-09-24.md)
- [Open Source / Public Standard Reference Synthesis Rounds 40–43](docs/research/OPEN_SOURCE_REFERENCE_SYNTHESIS_ROUNDS40_43_2026-09-24.md)
...
- [M0 Reference Adoption Plan v43 — current](docs/roadmap/M0_REFERENCE_ADOPTION_PLAN_V43.md)
- [M0 Reference Adoption Plan v42 — historical](docs/roadmap/M0_REFERENCE_ADOPTION_PLAN_V42.md)
